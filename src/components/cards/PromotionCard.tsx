    ...
    <div className='block'>
          ...
          <div className='flex flex-col text-sm text-gray-500 gap-2'>
            ...
            <div className='flex items-center gap-x-2.5'>
              <div className='flex items-center gap-x-1.5'>
                ...
                <span>
                  {formatToThaiDate(active_from)} -{' '}
                  {formatToThaiDate(active_until)}
                </span>
              </div>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex gap-3 text-xs'>
          <button className='flex items-center gap-2 px-3 py-2 border text-blue-600 font-semibold rounded-md transition-colors duration-200 hover:bg-blue-600 hover:text-white'>
